...
export class ImpulsoActorSheet extends BaseActorSheet {
  static DEFAULT_OPTIONS = {
    ...super.DEFAULT_OPTIONS,
    classes: ["impulso", "sheet", "actor"],
    position: { width: 752, height: 720 },
    form: {
      submitOnChange: true,
      submitOnClose: true
    },
    ...
    actions: {
      ...
      changeTab: ImpulsoActorSheet.#onChangeTab,
      rollDice: ImpulsoActorSheet.#onRollDice
    }
  };
  ...
  static PARTS = {
    ...
    sheet: {
      id: "sheet",
      template: "systems/impulso/templates/actors/actor-sheet.hbs",
      root: true,
      classes: ["impulso", "sheet", "actor"],
  ...
  static async #onRollDice(event, target) {
    ...
    // Base: 1 red + 1 black. Advantage: +1 red. Disadvantage: +1 black.
    ...
    // Advantage: keep highest red. Disadvantage: keep lowest black.
    ...
    const outcome = ImpulsoActorSheet.#resolveOutcome(diff);
